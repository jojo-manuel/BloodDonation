      ...
      <header className="relative z-10">
        <nav className="mx-auto flex w-full max-w-7xl items-center justify-between px-6 py-6">
          ...
          <div className="flex gap-3">
            {/* Removed Dashboard button as per request */}
            <button
              onClick={() => navigate("/dashboard")}
              className="px-5 py-2 rounded-full bg-gray-800 text-white text-sm font-medium shadow hover:bg-gray-700"
            >
              Find Donors
            </button>
            <button
            ...
            <button
              ...
              className="px-5 py-2 rounded-full bg-pink-500 text-white text-sm font-medium shadow hover:bg-pink-600"
            >
              Register
            </button>
          </div>
        ...
        <section className="w-full flex flex-col items-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center mb-12">
            <button
              ...
              className="px-6 py-3 rounded-full bg-pink-500 text-white font-semibold shadow hover:bg-pink-600 flex items-center gap-2"
            >
              <span>❤️</span> Become a Donor
            </button>
            <button
              onClick={() => navigate("/find-blood")}
              className="px-6 py-3 rounded-full bg-gray-800 text-white font-semibold shadow hover:bg-gray-700 flex items-center gap-2"
            >
              <span>👥</span> Find Blood
            </button>
            <button
              onClick={() => navigate("/bloodbank-login")}
              className="px-6 py-3 rounded-full bg-purple-600 text-white font-semibold shadow hover:bg-purple-700 flex items-center gap-2"
            >
